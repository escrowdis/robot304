...
void DW1000RangingClass::startAsAnchor(char address[], const byte mode[], const byte shortAddress, const bool randomShortAddress) {
	//save the address
	...
	if (randomShortAddress) {
		...
		_currentShortAddress[0] = shortAddress % 100;
		_currentShortAddress[1] = shortAddress / 100;
	}
	else {
